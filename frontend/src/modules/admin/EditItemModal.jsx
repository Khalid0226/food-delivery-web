...
export default function EditItemModal({ isOpen, onClose, item, onSave }) {
  ...
  <div className="bg-white w-full max-w-3xl rounded-[2rem] p-8 shadow-[0_20px_50px_rgba(0,0,0,0.15)] animate-in fade-in zoom-in duration-300">
    ...
    <div className="flex justify-between items-start mb-8">
      <div>
        <h2 className="text-3xl font-extrabold text-slate-950 tracking-tight">Edit "{formData.name}"</h2>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
      ...
      <div className="md:col-span-2 space-y-2">
        ...
        <textarea
          ...
          rows="3"
          placeholder="Briefly describe the ingredients and flavors..."
          className="w-full px-5 py-4 bg-slate-50 border-2 border-slate-100 rounded-2xl font-semibold outline-none focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all"
        ></textarea>
      </div>
    </div>
