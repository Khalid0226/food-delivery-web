...
export default function Login() {
  ...
  // 1. Form Data State (Only Email & Password needed for login)
  ...
  const handleSubmit = (e) => {
    ...
    if (validateForm()) {
      ...
      // Baad mein yahan JWT Token handling aur Backend API integration hoga
    }
  };
    ...
    <div className="min-h-screen bg-slate-50 text-slate-800 flex flex-col justify-center items-center px-4 py-6 relative overflow-x-hidden">
      ...
      <div className="bg-white p-6 md:p-8 rounded-2xl border border-slate-200 shadow-xl shadow-slate-200/40 w-full max-w-md relative z-10 transition-all">
        ...
        <form onSubmit={handleSubmit} noValidate className="space-y-4">
          ...
          <button
            type="submit"
            className="w-full bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 active:scale-[0.98] text-white font-black text-sm py-3.5 rounded-xl shadow-lg shadow-amber-500/20 transition-all uppercase tracking-widest border border-amber-400/10 mt-6"
          >
            Authenticate 🚀
          </button>
        </form>
