                            ...
                            <div className="space-y-6">
                                ...
                                <div className="space-y-4">
                                    {transactions.map(txn => (
                                        <div key={txn.id} className="flex flex-wrap items-center justify-between gap-4 p-5 rounded-2xl bg-slate-50 hover:bg-white border-2 border-slate-100 transition-all">
                                            ...
                                            <div className="flex items-center gap-4">
                                                ...
                                                <div className="min-w-0"> {/* min-w-0 zaruri hai takki text overflow na ho */}
